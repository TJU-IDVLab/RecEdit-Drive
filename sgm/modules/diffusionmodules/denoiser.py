...
class Denoiser(nn.Module):
    ...
    def forward(
        ...
        cond: Dict,
        cond_3d: Dict,
        sv3d_mode = 'interpolation',
        interpolation_inputs: Dict = None,
        **additional_model_inputs,
        ...
        model_output, model_output_3d, e_sv3d_time2, e_x_time2 = network(input * c_in, input_3d * c_in_3d, c_noise, c_noise_3d, cond, cond_3d,
                                                sv3d_mode, interpolation_inputs, **additional_model_inputs)
   
        return (
            model_output * c_out + input * c_skip,
            model_output_3d * c_out_3d + input_3d * c_skip_3d,
            e_sv3d_time2, e_x_time2
        )
