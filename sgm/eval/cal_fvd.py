...
def calculate_fvd(videos1, videos2, device, i3d=None, method='videogpt'):
    ...
    videos1 = trans(videos1).cpu()
    videos2 = trans(videos2).cpu()
    
    #fvd_results = {}

    # for calculate FVD, each clip_timestamp must >= 10
    # videos_clip [batch_size, channel, timestamps[:clip], h, w]
    videos_clip1 = einops.rearrange(videos1[:, :, :], 'b t c h w -> b c t h w')
    videos_clip2 = einops.rearrange(videos2[:, :, :], 'b t c h w -> b c t h w')
    # get FVD features
